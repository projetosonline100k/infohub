    ...
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4 py-10">
      ...
      <section className="relative w-full max-w-md rounded-2xl border border-border bg-card p-8 shadow-xl sm:p-10">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-card-foreground">Bem-vindo de volta</h1>
          <p className="mt-2 text-sm text-muted-foreground">Entre para acessar seu painel do infoprodutor.</p>
        </div>
